 ...
 */
const token =
  '006e213b99f5ab44846a756d8aa92dc3482IAC6pIJN3hktP+TpiMSLRIg430v8zvlCoCEQEUgyBzwrmnvgwIwAAAAAEAASVDxD4ap+YgEAAQDgqn5i';
const appId = 'e213b99f5ab44846a756d8aa92dc3482';
const channelName = 'chatApp';
/**
...
export default class App extends Component /*<null, State>*/ {
   ...
   */
  endCall = async () => {
    this.props.vvisble = false;
    await this._engine?.leaveChannel();
    this.setState({peerIds: [], joinSucceed: false});
  };

  render() {
    console.log('dfgdf', this.props.visble);
    return (
      <View style={[styles.max, {marginVertical: 50, flex: 8}]}>
